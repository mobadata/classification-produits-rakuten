...
def renderPreprocessing():
    ...
    if selected3=="Texte":
        ...
        with st.expander('Techniques principales appliquées'):        
            ...
            texte = ["""
                **Texte avec Filtrage des stop words, WordNetLemmatizer, et TF-IDF :**         
                ...
                """**Texte avec CBOW (Continuous Bag of Words) :**                                   
    ...
    if selected3=="Équilibrage des classes":
        ...
        st.markdown("""
            ...
            suite à le preprocessing des images, 
